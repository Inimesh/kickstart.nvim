...
-- If a file's contents is altered outside of neovim then the buffer
...
vim.keymap.set('n', '<C-w>/', function()
  local half_window_height = vim.api.nvim_win_get_height(0) / 2
  vim.cmd('resize ' .. half_window_height)
end, { desc = 'Half the window height' })

vim.keymap.set('n', '<C-w>?', function()
  local double_window_height = vim.api.nvim_win_get_height(0) * 2
  vim.cmd('resize ' .. double_window_height)
end, { desc = 'Double the window height' })
...
require('lazy').setup({
  ...
  { 'NMAC427/guess-indent.nvim', opts = { override_editorconfig = true } }, -- Detect tabstop and shiftwidth automatically
